...
Additional dynamics may be incorporated into a state feedback regulating system
in order to beneficially alter the response of the system in various respects.
