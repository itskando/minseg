...
%% These will be placed on the signature lines in the order they appear
%% when the electronic option is given in the \documentclass command.
%% There should be one \signature for each committe member.
\signature{Major Professor}
\signature{First Committee Member}
\signature{Second Committee Member}
\deansignature{Nasser H. Zawia}
