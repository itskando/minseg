...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/minseg_M2V3_2017a.elf
...
PRODUCT_NAME              = minseg_M2V3_2017a
MAKEFILE                  = minseg_M2V3_2017a.mk
COMPUTER                  = MACI64
...
MODELREF_LINK_RSPFILE_NAME = minseg_M2V3_2017a_ref.rsp
...
# Toolchain Name:          Arduino AVR v1.6.13 | gmake (64-bit Mac)
# Supported Version(s):    
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/minseg_M2V3_2017a.elf
...
DEFINES_ = -D_RTT_USE_SERIAL0_ -DMODEL=minseg_M2V3_2017a -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DONESTEPFCN=1 -DTERMFCN=1 -DMULTI_INSTANCE_CODE=0 -DTID01EQ=0 -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT -D_MW_ARDUINO_LOOP_=1 -DMW_ARDUINO_STEP_SIZE=15000 -DMW_ARDUINO_MICROS -D_RTT_BAUDRATE_SERIAL0_=115200 -D_RTT_BAUDRATE_SERIAL1_=115200 -D_RTT_BAUDRATE_SERIAL2_=115200 -D_RTT_BAUDRATE_SERIAL3_=115200 -D_RTT_ANALOG_REF_=0 -D_RTT_OVERRUN_DIGITAL_PIN_=13
...
DEFINES_STANDARD = -DMODEL=minseg_M2V3_2017a -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
%.o : $(START_DIR)/minseg_M2V3_2017a_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/minseg_M2V3_2017a_ert_rtw/%.s
	$(AS) $(ASFLAGS)  $@ $<


%.o : $(START_DIR)/minseg_M2V3_2017a_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : /Users/kando/Documents/MATLAB/RASPlib_2017_05_02/RASPlib/src/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : /Users/kando/Documents/MATLAB/RASPlib_2017_05_02/RASPlib/src/%.s
	$(AS) $(ASFLAGS)  $@ $<


%.o : /Users/kando/Documents/MATLAB/RASPlib_2017_05_02/RASPlib/src/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : /Users/kando/Documents/MATLAB/SupportPackages/R2017a/3P.instrset/arduinoide.instrset/Arduino.app/Contents/Java/hardware/arduino/avr/libraries/Wire/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : /Users/kando/Documents/MATLAB/SupportPackages/R2017a/3P.instrset/arduinoide.instrset/Arduino.app/Contents/Java/hardware/arduino/avr/libraries/Wire/%.s
	$(AS) $(ASFLAGS)  $@ $<


%.o : /Users/kando/Documents/MATLAB/SupportPackages/R2017a/3P.instrset/arduinoide.instrset/Arduino.app/Contents/Java/hardware/arduino/avr/libraries/Wire/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : /Users/kando/Documents/MATLAB/SupportPackages/R2017a/3P.instrset/arduinoide.instrset/Arduino.app/Contents/Java/hardware/arduino/avr/libraries/Wire/src/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : /Users/kando/Documents/MATLAB/SupportPackages/R2017a/3P.instrset/arduinoide.instrset/Arduino.app/Contents/Java/hardware/arduino/avr/libraries/Wire/src/%.s
	$(AS) $(ASFLAGS)  $@ $<


%.o : /Users/kando/Documents/MATLAB/SupportPackages/R2017a/3P.instrset/arduinoide.instrset/Arduino.app/Contents/Java/hardware/arduino/avr/libraries/Wire/src/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : /Users/kando/Documents/MATLAB/SupportPackages/R2017a/3P.instrset/arduinoide.instrset/Arduino.app/Contents/Java/hardware/arduino/avr/libraries/Wire/src/utility/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : /Users/kando/Documents/MATLAB/SupportPackages/R2017a/3P.instrset/arduinoide.instrset/Arduino.app/Contents/Java/hardware/arduino/avr/libraries/Wire/src/utility/%.s
	$(AS) $(ASFLAGS)  $@ $<


%.o : /Users/kando/Documents/MATLAB/SupportPackages/R2017a/3P.instrset/arduinoide.instrset/Arduino.app/Contents/Java/hardware/arduino/avr/libraries/Wire/src/utility/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : /Users/kando/Documents/MATLAB/SupportPackages/R2017a/3P.instrset/arduinoide.instrset/Arduino.app/Contents/Java/hardware/arduino/avr/libraries/Wire/utility/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : /Users/kando/Documents/MATLAB/SupportPackages/R2017a/3P.instrset/arduinoide.instrset/Arduino.app/Contents/Java/hardware/arduino/avr/libraries/Wire/utility/%.s
	$(AS) $(ASFLAGS)  $@ $<


%.o : /Users/kando/Documents/MATLAB/SupportPackages/R2017a/3P.instrset/arduinoide.instrset/Arduino.app/Contents/Java/hardware/arduino/avr/libraries/Wire/utility/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


digitalio_arduino.o : /Users/kando/Documents/MATLAB/RASPlib_2017_05_02/RASPlib/blocks/../src/digitalio_arduino.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


encoder_arduino.o : /Users/kando/Documents/MATLAB/RASPlib_2017_05_02/RASPlib/blocks/../src/encoder_arduino.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


PWMFSelect.o : /Users/kando/Documents/MATLAB/RASPlib_2017_05_02/RASPlib/blocks/../src/PWMFSelect.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


MW_SerialWrite.o : /Users/kando/Documents/MATLAB/SupportPackages/R2017a/toolbox/target/supportpackages/arduinobase/src/MW_SerialWrite.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
MW_ArduinoHWInit.o : /Users/kando/Documents/MATLAB/SupportPackages/R2017a/toolbox/target/supportpackages/arduinotarget/registry/../src/MW_ArduinoHWInit.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


io_wrappers.o : /Users/kando/Documents/MATLAB/SupportPackages/R2017a/toolbox/target/supportpackages/arduinobase/src/io_wrappers.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


arduinoAVRScheduler.o : /Users/kando/Documents/MATLAB/SupportPackages/R2017a/toolbox/target/supportpackages/arduinotarget/registry/../scheduler/src/arduinoAVRScheduler.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
