...
## 
## Makefile     : lab2_2.mk
## Generated on : Thu Jan 26 12:15:09 2017
## MATLAB Coder version: 3.0 (R2015b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/lab2_2.elf
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/kando/Documents/MATLAB/thesis/2016.12.29\ RPI\ Mechatronics\ Labs/2.02
ARCH                      = maci64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/lab2_2.elf
...
INCLUDES_BUILDINFO = -I/Users/kando/Documents/MATLAB/Libraries/RPI_MinSeg/20170117_rev1p3/RASPlib/blocks/../src -I/Users/kando/Documents/MATLAB/Libraries/RPI_MinSeg/20170117_rev1p3/RASPlib/blocks/../include -I/Users/kando/Documents/MATLAB/SupportPackages/R2015b/arduinobase/toolbox/target/supportpackages/arduinobase/include -I/Users/kando/Documents/MATLAB/SupportPackages/R2015b/arduinobase/toolbox/target/supportpackages/arduinobase/blocks/sfcn/include -I$(START_DIR)/lab2_2_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_ROOT)/hardware/arduino/avr/variants/mega -I/Users/kando/Documents/MATLAB/SupportPackages/R2015b/arduino/toolbox/target/supportpackages/arduinotarget/registry/../include -I/Users/kando/Documents/MATLAB/SupportPackages/R2015b/arduino/toolbox/target/supportpackages/arduinotarget/registry/../scheduler/include
...
DEFINES_STANDARD = -DMODEL=lab2_2 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
%.o : $(START_DIR)/lab2_2_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/lab2_2_ert_rtw/%.s
	$(AS) $(ASFLAGS)  "$@" "$<"


%.o : $(START_DIR)/lab2_2_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


encoder_arduino.o : /Users/kando/Documents/MATLAB/Libraries/RPI_MinSeg/20170117_rev1p3/RASPlib/blocks/../src/encoder_arduino.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


PWMFSelect.o : /Users/kando/Documents/MATLAB/Libraries/RPI_MinSeg/20170117_rev1p3/RASPlib/blocks/../src/PWMFSelect.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
