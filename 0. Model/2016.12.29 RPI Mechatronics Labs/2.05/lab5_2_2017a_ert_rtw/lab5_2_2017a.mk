###########################################################################
## Makefile generated for Simulink model 'lab5_2_2017a'. 
## 
## Makefile     : lab5_2_2017a.mk
## Generated on : Thu Apr 06 17:05:07 2017
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/lab5_2_2017a.elf
...
MODELREF_LINK_RSPFILE_NAME = lab5_2_2017a_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/lab5_2_2017a.elf
...
DEFINES_ = -D_RTT_USE_SERIAL0_ -DMODEL=lab5_2_2017a -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DONESTEPFCN=1 -DTERMFCN=1 -DMULTI_INSTANCE_CODE=0 -DTID01EQ=0 -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT -D_MW_ARDUINO_LOOP_=1 -DMW_ARDUINO_STEP_SIZE=2000 -DMW_ARDUINO_MICROS -D_RTT_BAUDRATE_SERIAL0_=115200 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_BAUDRATE_SERIAL2_=9600 -D_RTT_BAUDRATE_SERIAL3_=9600 -D_RTT_ANALOG_REF_=0 -D_RTT_OVERRUN_DIGITAL_PIN_=13
...
DEFINES_STANDARD = -DMODEL=lab5_2_2017a -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
%.o : $(START_DIR)/lab5_2_2017a_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/lab5_2_2017a_ert_rtw/%.s
	$(AS) $(ASFLAGS)  $@ $<


%.o : $(START_DIR)/lab5_2_2017a_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
