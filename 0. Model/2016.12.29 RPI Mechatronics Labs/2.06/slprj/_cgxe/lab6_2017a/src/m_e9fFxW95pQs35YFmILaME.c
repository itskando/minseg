...
static emlrtRSInfo emlrtRSI = { 1,     /* lineNo */
  ...
  "/Users/kando/Documents/MATLAB/SupportPackages/R2017a/toolbox/target/supportpackages/arduinobase/+codertarget/+arduinobase/+inter"
  "nal/arduino_SerialWrite.p"          /* pathName */
};
...
static emlrtRSInfo f_emlrtRSI = { 1,   /* lineNo */
  "Propagates",                        /* fcnName */
  "/Applications/MATLAB_R2017a.app/toolbox/shared/system/coder/+matlab/+system/+mixin/+coder/Propagates.p"/* pathName */
};

static emlrtRSInfo g_emlrtRSI = { 1,   /* lineNo */
  "CustomIcon",                        /* fcnName */
  "/Applications/MATLAB_R2017a.app/toolbox/matlab/system/+matlab/+system/+mixin/CustomIcon.p"/* pathName */
};
...
static void cgxe_mdl_start(InstanceStruct_e9fFxW95pQs35YFmILaME *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_e9fFxW95pQs35YFmILaME
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_e9fFxW95pQs35YFmILaME
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_e9fFxW95pQs35YFmILaME *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_e9fFxW95pQs35YFmILaME
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_e9fFxW95pQs35YFmILaME *moduleInstance);
...
static void cgxe_mdl_set_sim_state(InstanceStruct_e9fFxW95pQs35YFmILaME
...
static boolean_T j_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_e9fFxW95pQs35YFmILaME
  *moduleInstance);
...
static void cgxe_mdl_start(InstanceStruct_e9fFxW95pQs35YFmILaME *moduleInstance)
{
  ...
  static int8_T iv4[8] = { 13, 1, 1, 1, 1, 1, 1, 1 };
  ...
  for (i0 = 0; i0 < 8; i0++) {
    varSizes[0].f1[i0] = (uint32_T)iv4[i0];
  }
  ...
  *moduleInstance)
{
  ...
  static int8_T inSize[8] = { 13, 1, 1, 1, 1, 1, 1, 1 };
  ...
  (InstanceStruct_e9fFxW95pQs35YFmILaME *moduleInstance)
{
  ...
  *(int32_T *)mxGetData(m4) = moduleInstance->sysobj.isInitialized;
  ...
  c_y = NULL;
  iv15[0] = 1;
  emlrtAssign(&c_y, emlrtCreateStructArray(1, iv15, 0, NULL));
  r0 = &u[0];
  for (i1 = 0; i1 < 8; i1++) {
    b_u[i1] = r0->f1[i1];
  }
  ...
  *moduleInstance)
{
  moduleInstance->emlrtRootTLSGlobal = (void *)cgxertGetEMLRTCtx
    (moduleInstance->S);
  moduleInstance->u0 = (uint8_T (*)[13])cgxertGetInputPortSignal
    (moduleInstance->S, 0);
}

/* CGXE Glue Code */
static void mdlOutputs_e9fFxW95pQs35YFmILaME(SimStruct *S, int_T tid)
{
  InstanceStruct_e9fFxW95pQs35YFmILaME *moduleInstance =
    (InstanceStruct_e9fFxW95pQs35YFmILaME *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_e9fFxW95pQs35YFmILaME(SimStruct *S)
{
  InstanceStruct_e9fFxW95pQs35YFmILaME *moduleInstance =
    (InstanceStruct_e9fFxW95pQs35YFmILaME *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_e9fFxW95pQs35YFmILaME(SimStruct *S, int_T tid)
{
  InstanceStruct_e9fFxW95pQs35YFmILaME *moduleInstance =
    (InstanceStruct_e9fFxW95pQs35YFmILaME *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_e9fFxW95pQs35YFmILaME(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_e9fFxW95pQs35YFmILaME *moduleInstance =
    (InstanceStruct_e9fFxW95pQs35YFmILaME *)cgxertGetRuntimeInstance(S);
...
static void setSimState_e9fFxW95pQs35YFmILaME(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_e9fFxW95pQs35YFmILaME *moduleInstance =
    (InstanceStruct_e9fFxW95pQs35YFmILaME *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_e9fFxW95pQs35YFmILaME(SimStruct *S)
{
  InstanceStruct_e9fFxW95pQs35YFmILaME *moduleInstance =
    (InstanceStruct_e9fFxW95pQs35YFmILaME *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_e9fFxW95pQs35YFmILaME(SimStruct *S)
{
  InstanceStruct_e9fFxW95pQs35YFmILaME *moduleInstance =
    (InstanceStruct_e9fFxW95pQs35YFmILaME *)calloc(1, sizeof
    (InstanceStruct_e9fFxW95pQs35YFmILaME));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_e9fFxW95pQs35YFmILaME);
  ssSetmdlInitializeConditions(S, mdlInitialize_e9fFxW95pQs35YFmILaME);
  ssSetmdlUpdate(S, mdlUpdate_e9fFxW95pQs35YFmILaME);
  ssSetmdlTerminate(S, mdlTerminate_e9fFxW95pQs35YFmILaME);
...
static void mdlProcessParameters_e9fFxW95pQs35YFmILaME(SimStruct *S)
{
}

void method_dispatcher_e9fFxW95pQs35YFmILaME(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_e9fFxW95pQs35YFmILaME(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_e9fFxW95pQs35YFmILaME(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_e9fFxW95pQs35YFmILaME(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_e9fFxW95pQs35YFmILaME(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: e9fFxW95pQs35YFmILaME.\n"
...
mxArray *cgxe_e9fFxW95pQs35YFmILaME_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_e9fFxW95pQs35YFmILaME_fallback_info(void)
{
