###########################################################################
## Makefile generated for Simulink model 'lab6_2017a'. 
## 
## Makefile     : lab6_2017a.mk
## Generated on : Thu May 18 09:05:05 2017
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/lab6_2017a.elf
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/kando/Google\ Drive/thesis/0.\ Model/2016.12.29\ RPI\ Mechatronics\ Labs/2.06
ARCH                      = maci64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = lab6_2017a_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/lab6_2017a.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I/Users/kando/Documents/MATLAB/RASPlib_2017_05_02/RASPlib/src -I/Users/kando/Documents/MATLAB/RASPlib_2017_05_02/RASPlib/include -I/Users/kando/Documents/MATLAB/SupportPackages/R2017a/toolbox/target/supportpackages/arduinobase/include -I$(START_DIR)/lab6_2017a_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_ROOT)/hardware/arduino/avr/variants/mega -I/Users/kando/Documents/MATLAB/SupportPackages/R2017a/toolbox/target/supportpackages/arduinotarget/include -I/Users/kando/Documents/MATLAB/SupportPackages/R2017a/toolbox/target/supportpackages/arduinotarget/scheduler/include -I$(ARDUINO_ROOT)/hardware/tools/avr/avr/include/avr -I/Users/kando/Documents/MATLAB/SupportPackages/R2017a/toolbox/target/shared/externalmode_daemon/include
...
DEFINES_STANDARD = -DMODEL=lab6_2017a -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
SRCS = /Users/kando/Documents/MATLAB/RASPlib_2017_05_02/RASPlib/blocks/../src/encoder_arduino.cpp /Users/kando/Documents/MATLAB/RASPlib_2017_05_02/RASPlib/blocks/../src/PWMFSelect.cpp /Users/kando/Documents/MATLAB/SupportPackages/R2017a/toolbox/target/supportpackages/arduinobase/src/MW_digitalio.cpp $(START_DIR)/lab6_2017a_ert_rtw/lab6_2017a.c $(START_DIR)/lab6_2017a_ert_rtw/lab6_2017a_data.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/hooks.c $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/WInterrupts.c $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/wiring.c $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/wiring_analog.c $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/wiring_digital.c $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/wiring_pulse.c $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/wiring_shift.c $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/abi.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/CDC.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/HardwareSerial.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/HardwareSerial0.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/HardwareSerial1.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/HardwareSerial2.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/HardwareSerial3.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/PluggableUSB.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/IPAddress.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/new.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/Print.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/Stream.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/Tone.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/USBCore.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/WMath.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/WString.cpp /Users/kando/Documents/MATLAB/SupportPackages/R2017a/toolbox/target/supportpackages/arduinotarget/registry/../src/MW_ArduinoHWInit.cpp /Users/kando/Documents/MATLAB/SupportPackages/R2017a/toolbox/target/supportpackages/arduinobase/src/io_wrappers.cpp /Users/kando/Documents/MATLAB/SupportPackages/R2017a/toolbox/target/supportpackages/arduinotarget/registry/../scheduler/src/arduinoAVRScheduler.cpp $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c /Users/kando/Documents/MATLAB/SupportPackages/R2017a/toolbox/target/shared/externalmode_daemon/src/ext_svr_daemon.c /Users/kando/Documents/MATLAB/SupportPackages/R2017a/toolbox/target/supportpackages/arduinotarget/registry/../src/rtiostream_serial_daemon.cpp /Users/kando/Documents/MATLAB/SupportPackages/R2017a/toolbox/target/shared/externalmode_daemon/src/daemon_checksum.c

MAIN_SRC = $(START_DIR)/lab6_2017a_ert_rtw/ert_main.c
...
%.o : $(START_DIR)/lab6_2017a_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/lab6_2017a_ert_rtw/%.s
	$(AS) $(ASFLAGS)  $@ $<


%.o : $(START_DIR)/lab6_2017a_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
MW_digitalio.o : /Users/kando/Documents/MATLAB/SupportPackages/R2017a/toolbox/target/supportpackages/arduinobase/src/MW_digitalio.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
ext_svr_daemon.o : /Users/kando/Documents/MATLAB/SupportPackages/R2017a/toolbox/target/shared/externalmode_daemon/src/ext_svr_daemon.c
	$(CC) $(CFLAGS) -o $@ $<


rtiostream_serial_daemon.o : /Users/kando/Documents/MATLAB/SupportPackages/R2017a/toolbox/target/supportpackages/arduinotarget/registry/../src/rtiostream_serial_daemon.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


daemon_checksum.o : /Users/kando/Documents/MATLAB/SupportPackages/R2017a/toolbox/target/shared/externalmode_daemon/src/daemon_checksum.c
	$(CC) $(CFLAGS) -o $@ $<
