...
static emlrtRSInfo emlrtRSI = { 1,     /* lineNo */
  "soMPU6050Temp",                     /* fcnName */
  "/Users/kando/Documents/MATLAB/RASPlib_2017_05_02/RASPlib/blocks/soMPU6050Temp.m"/* pathName */
};
...
static void cgxe_mdl_start(InstanceStruct_LD14f1zUZZpHtTQLg21j6 *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_LD14f1zUZZpHtTQLg21j6
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_LD14f1zUZZpHtTQLg21j6
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_LD14f1zUZZpHtTQLg21j6 *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_LD14f1zUZZpHtTQLg21j6
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_LD14f1zUZZpHtTQLg21j6 *moduleInstance);
static soMPU6050Temp emlrt_marshallIn(const emlrtStack *sp, const mxArray
  *b_sysobj, const char_T *identifier);
static soMPU6050Temp b_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u,
...
static boolean_T e_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u,
  const emlrtMsgIdentifier *parentId);
static void cgxe_mdl_set_sim_state(InstanceStruct_LD14f1zUZZpHtTQLg21j6
...
static boolean_T g_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_LD14f1zUZZpHtTQLg21j6
  *moduleInstance);
...
static void cgxe_mdl_start(InstanceStruct_LD14f1zUZZpHtTQLg21j6 *moduleInstance)
{
  ...
  covrtIfInit(moduleInstance->covInst_CONTAINER_BLOCK_INDEX, 0U, 2U, 2011, 2044,
              -1, 4272);
  covrtIfInit(moduleInstance->covInst_CONTAINER_BLOCK_INDEX, 0U, 0U, 1083, 1105,
              1314, 1345);
  covrtIfInit(moduleInstance->covInst_CONTAINER_BLOCK_INDEX, 0U, 1U, 1314, 1343,
              -1, 1345);
...
/* CGXE Glue Code */
static void mdlOutputs_LD14f1zUZZpHtTQLg21j6(SimStruct *S, int_T tid)
{
  InstanceStruct_LD14f1zUZZpHtTQLg21j6 *moduleInstance =
    (InstanceStruct_LD14f1zUZZpHtTQLg21j6 *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_LD14f1zUZZpHtTQLg21j6(SimStruct *S)
{
  InstanceStruct_LD14f1zUZZpHtTQLg21j6 *moduleInstance =
    (InstanceStruct_LD14f1zUZZpHtTQLg21j6 *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_LD14f1zUZZpHtTQLg21j6(SimStruct *S, int_T tid)
{
  InstanceStruct_LD14f1zUZZpHtTQLg21j6 *moduleInstance =
    (InstanceStruct_LD14f1zUZZpHtTQLg21j6 *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_LD14f1zUZZpHtTQLg21j6(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_LD14f1zUZZpHtTQLg21j6 *moduleInstance =
    (InstanceStruct_LD14f1zUZZpHtTQLg21j6 *)cgxertGetRuntimeInstance(S);
...
static void setSimState_LD14f1zUZZpHtTQLg21j6(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_LD14f1zUZZpHtTQLg21j6 *moduleInstance =
    (InstanceStruct_LD14f1zUZZpHtTQLg21j6 *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_LD14f1zUZZpHtTQLg21j6(SimStruct *S)
{
  InstanceStruct_LD14f1zUZZpHtTQLg21j6 *moduleInstance =
    (InstanceStruct_LD14f1zUZZpHtTQLg21j6 *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_LD14f1zUZZpHtTQLg21j6(SimStruct *S)
{
  InstanceStruct_LD14f1zUZZpHtTQLg21j6 *moduleInstance =
    (InstanceStruct_LD14f1zUZZpHtTQLg21j6 *)calloc(1, sizeof
    (InstanceStruct_LD14f1zUZZpHtTQLg21j6));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_LD14f1zUZZpHtTQLg21j6);
  ssSetmdlInitializeConditions(S, mdlInitialize_LD14f1zUZZpHtTQLg21j6);
  ssSetmdlUpdate(S, mdlUpdate_LD14f1zUZZpHtTQLg21j6);
  ssSetmdlTerminate(S, mdlTerminate_LD14f1zUZZpHtTQLg21j6);
...
static void mdlProcessParameters_LD14f1zUZZpHtTQLg21j6(SimStruct *S)
{
}

void method_dispatcher_LD14f1zUZZpHtTQLg21j6(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_LD14f1zUZZpHtTQLg21j6(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_LD14f1zUZZpHtTQLg21j6(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_LD14f1zUZZpHtTQLg21j6(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_LD14f1zUZZpHtTQLg21j6(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: LD14f1zUZZpHtTQLg21j6.\n"
...
mxArray *cgxe_LD14f1zUZZpHtTQLg21j6_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
  ...
  elem_9 = mxCreateString("soMPU6050Temp");
...
mxArray *cgxe_LD14f1zUZZpHtTQLg21j6_fallback_info(void)
{
  const char* fallbackInfoFields[] = { "fallbackType", "incompatiableSymbol" };

  mxArray* fallbackInfoStruct = mxCreateStructMatrix(1, 1, 2, fallbackInfoFields);
  mxArray* fallbackType = mxCreateString("thirdPartyLibs");
  mxArray* incompatibleSymbol = mxCreateString("soMPU6050Temp");
