...
static void cgxe_mdl_start(InstanceStruct_0q9lZWm65339Jv4e8zasUF *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_0q9lZWm65339Jv4e8zasUF
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_0q9lZWm65339Jv4e8zasUF
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_0q9lZWm65339Jv4e8zasUF
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_0q9lZWm65339Jv4e8zasUF
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_0q9lZWm65339Jv4e8zasUF *moduleInstance);
...
static void cgxe_mdl_set_sim_state(InstanceStruct_0q9lZWm65339Jv4e8zasUF
...
static boolean_T j_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_0q9lZWm65339Jv4e8zasUF
  *moduleInstance);
...
static void cgxe_mdl_start(InstanceStruct_0q9lZWm65339Jv4e8zasUF *moduleInstance)
{
  ...
  static int8_T iv4[8] = { 40, 1, 1, 1, 1, 1, 1, 1 };
  ...
  *moduleInstance)
{
  moduleInstance->emlrtRootTLSGlobal = (void *)cgxertGetEMLRTCtx
    (moduleInstance->S);
  moduleInstance->u0 = (uint8_T (*)[40])cgxertGetInputPortSignal
    (moduleInstance->S, 0);
}

/* CGXE Glue Code */
static void mdlOutputs_0q9lZWm65339Jv4e8zasUF(SimStruct *S, int_T tid)
{
  InstanceStruct_0q9lZWm65339Jv4e8zasUF *moduleInstance =
    (InstanceStruct_0q9lZWm65339Jv4e8zasUF *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_0q9lZWm65339Jv4e8zasUF(SimStruct *S)
{
  InstanceStruct_0q9lZWm65339Jv4e8zasUF *moduleInstance =
    (InstanceStruct_0q9lZWm65339Jv4e8zasUF *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_0q9lZWm65339Jv4e8zasUF(SimStruct *S, int_T tid)
{
  InstanceStruct_0q9lZWm65339Jv4e8zasUF *moduleInstance =
    (InstanceStruct_0q9lZWm65339Jv4e8zasUF *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_0q9lZWm65339Jv4e8zasUF(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_0q9lZWm65339Jv4e8zasUF *moduleInstance =
    (InstanceStruct_0q9lZWm65339Jv4e8zasUF *)cgxertGetRuntimeInstance(S);
...
static void setSimState_0q9lZWm65339Jv4e8zasUF(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_0q9lZWm65339Jv4e8zasUF *moduleInstance =
    (InstanceStruct_0q9lZWm65339Jv4e8zasUF *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_0q9lZWm65339Jv4e8zasUF(SimStruct *S)
{
  InstanceStruct_0q9lZWm65339Jv4e8zasUF *moduleInstance =
    (InstanceStruct_0q9lZWm65339Jv4e8zasUF *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_0q9lZWm65339Jv4e8zasUF(SimStruct *S)
{
  InstanceStruct_0q9lZWm65339Jv4e8zasUF *moduleInstance =
    (InstanceStruct_0q9lZWm65339Jv4e8zasUF *)calloc(1, sizeof
    (InstanceStruct_0q9lZWm65339Jv4e8zasUF));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_0q9lZWm65339Jv4e8zasUF);
  ssSetmdlInitializeConditions(S, mdlInitialize_0q9lZWm65339Jv4e8zasUF);
  ssSetmdlUpdate(S, mdlUpdate_0q9lZWm65339Jv4e8zasUF);
  ssSetmdlTerminate(S, mdlTerminate_0q9lZWm65339Jv4e8zasUF);
...
static void mdlProcessParameters_0q9lZWm65339Jv4e8zasUF(SimStruct *S)
{
}

void method_dispatcher_0q9lZWm65339Jv4e8zasUF(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_0q9lZWm65339Jv4e8zasUF(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_0q9lZWm65339Jv4e8zasUF(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_0q9lZWm65339Jv4e8zasUF(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_0q9lZWm65339Jv4e8zasUF(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: 0q9lZWm65339Jv4e8zasUF.\n"
...
mxArray *cgxe_0q9lZWm65339Jv4e8zasUF_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_0q9lZWm65339Jv4e8zasUF_fallback_info(void)
{
